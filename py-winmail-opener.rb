class PyWinmailOpener < Formula
  ...
  url "https://github.com/jsbattig/py-winmail-opener/archive/refs/tags/v1.0.6.tar.gz"
  ...
  test do
    ...
    assert_match "winmail_opener 1.0.6", shell_output("#{bin}/winmail-opener --version")
  end
end
